...
class one extends PluginBase implements Listener
{
    ...
    public function onRun(PlayerMoveEvent $event): void
    {
        ...
        $items = [$fhotbarItem, Item::get(332, 0, 16), Item::get(322, 0, 16), Item::get(368, 0, 16), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1), Item::get(438, 29, 1)]; // the rest of items
        ...
        $fhotbarEnchant = [new EnchantmentInstance(Enchantment::getEnchantment(9), 3),
        ...
        $chestEnchant = [new EnchantmentInstance(Enchantment::getEnchantment(17), 3),
            new EnchantmentInstance(Enchantment::getEnchantment(1), 2)];
        $leggingsEnchant = [new EnchantmentInstance(Enchantment::getEnchantment(17), 3)];
        $bootsEnchant = [new EnchantmentInstance(Enchantment::getEnchantment(17), 3)];
